...
function getUniqueImage(url: string, content: string, title: string) {
  ...
  // Use Clearbit to fetch the official logo of the company/website, exactly like Software.
  // BookCard.tsx will render this beautifully inside the white box container.
  // If Clearbit fails, BookCard's onError will fallback to a crisp UI Avatar.
